    ...
    if (this.languageToLearn === 'ro') {
      ...
      this.slidesIntermediate = [
        ...
        },
        {
          ...
          translation: 'Dacă aș avea un milion de dolari, aș cumpăra o casă.',
        },
        {
      ...
      this.slidesAdvanced = [
        ...
        {
          native: 'By next month, I will have been working here for 5 years.',
        ...
        {
          native: 'If I had studied, I would be able to answer the question.',
          translation:
            'Dacă aș fi studiat, aș fi fost capabil să răspund la întrebare.',
        },
        {
          native: 'I would have been happier if I had gone to the party.',
          translation: 'Aș fi fost mai fericit dacă aș fi mers la petrecere.',
        },
      ];
      ...
      this.slidesAdvanced = [
        ...
        {
          native: 'I would have been happier if I had gone to the party.',
          translation: 'J’aurais été plus heureux si j’étais allé à la fête.',
        },
      ];
      ...
      this.slidesAdvanced = [
        ...
        {
          native: 'At that time, I thought I would never see him again.',
          translation: 'At that time, I though I would never see him again.',
        },
        {
          native: 'If he were to finish on time, it would have been great.',
          translation:
        ...
        {
          native: 'I would have been happier if I had gone to the party.',
          translation: 'I would have been happier if I had gone to the party.',
        },
      ];
    }
